...
map.getView().fit([-1133771.231696, 3594887.798664, -701247.502884, 3929322.347125], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech-Safi ( by Chennouf )</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (188 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte choroplèthe interactive basée sur la variation de la population entre les différentes provinces de la région de Marrakech Safiselon le recensement du septembre 2024';
            }
